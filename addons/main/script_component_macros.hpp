...
#define VAR_CAN_INSTALL RGVAR(canInstall)
...
#define QVAR_CAN_INSTALL QUOTE(VAR_CAN_INSTALL)
...
#define CAN_INSTALL(var1) GETVAR(var1,VAR_CAN_INSTALL,true)
...
#define SET_CAN_INSTALL(var1,var2) SETVARGLOBAL(var1,VAR_CAN_INSTALL,var2)
